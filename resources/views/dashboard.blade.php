...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset-dashboard/css/index.css') }}">
            ...
            <aside class="sidebar">
                <a href="#" class="sidebar-logo">
                    <div class="d-flex justify-content-start align-items-center">
                        <img src="{{ asset('asset-dashboard/assets/img/global/logo.svg') }}" alt="">
                        <span>PowerHuman</span>
                    </div>

                    <button id="toggle-navbar" onclick="toggleNavbar()">
                        <img src="{{ asset('asset-dashboard/assets/img/global/navbar-times.svg') }}" alt="">
                    </button>
                </a>
        ...
        <div class="col-12 col-xl-9">
            <div class="nav">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-center">
                        <button id="toggle-navbar" onclick="toggleNavbar()">
                            <img src="{{ asset('asset-dashboard/assets/img/global/burger.svg') }}./assets/img/global/burger.svg" class="mb-2" alt="">
                        </button>
                        <h2 class="nav-title">Overview</h2>
                    </div>
                    <button class="btn-notif d-block d-md-none"><img src="{{ asset('asset-dashboard/assets/img/global/bell.svg') }}" alt=""></button>
                </div>

                <div class="d-flex justify-content-between align-items-center nav-input-container">
                    <div class="nav-input-group">
                        <input type="text" class="nav-input" placeholder="Search people, team, project">
                        <button class="btn-nav-input"><img src="{{ asset('asset-dashboard/assets/img/global/search.svg') }}" alt=""></button>
                    </div>

                    <button class="btn-notif d-none d-md-block"><img src="{{ asset('asset-dashboard/assets/img/global/bell.svg') }}" alt=""></button>
                </div>
            </div>
                        ...
                        <div class="statistics-card">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <button class="btn-statistics">
                                    <img src="{{ asset('asset-dashboard/assets/img/global/times.svg') }}" alt="">
                                </button>
                            </div>

                            <div class="statistics-list">
                                <img class="statistics-image" src="{{ asset('asset-dashboard/assets/img/home/history/photo-4.png') }}" alt="">
                                <img class="statistics-image" src="{{ asset('asset-dashboard/assets/img/home/history/photo-3.png') }}" alt="">
                                <img class="statistics-image" src="{{ asset('asset-dashboard/assets/img/home/history/photo.png') }}" alt="">
                                <img class="statistics-image" src="{{ asset('asset-dashboard/assets/img/home/history/photo-1.png') }}" alt="">
                                <img class="statistics-image" src="{{ asset('asset-dashboard/assets/img/home/history/photo-2.png') }}" alt="">
                            </div>
                        ...
                        <div class="statistics-card">
                            ...
                            <div class="statistics-list">
                                <div class="statistics-icon award">
                                    <img src="{{ asset('asset-dashboard/assets/img/home/team/award.svg') }}" alt="">
                                </div>
                                <div class="statistics-icon globe">
                                    <img src="{{ asset('asset-dashboard/assets/img/home/team/globe.svg') }}" alt="">
                                </div>
                                <div class="statistics-icon target">
                                    <img src="{{ asset('asset-dashboard/assets/img/home/team/target.svg') }}" alt="">
                                </div>
                                <div class="statistics-icon box">
                                    <img src="{{ asset('asset-dashboard/assets/img/home/team/box.svg') }}" alt="">
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="document-icon box">
                                        <img src="{{ asset('asset-dashboard/assets/img/home/document/archive.svg') }}" alt="">
                                    </div>
                                ...
                                <button class="btn-statistics">
                                    <img src="{{ asset('asset-dashboard/assets/img/global/download.svg') }}" alt="">
                                </button>
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="document-icon globe">
                                        <img src="{{ asset('asset-dashboard/assets/img/home/document/twitch.svg') }}" alt="">
                                    </div>
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="document-icon database">
                                        <img src="{{ asset('asset-dashboard/assets/img/home/document/database.svg') }}" alt="">
                                    </div>
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <div class="document-icon target">
                                        <img src="{{ asset('asset-dashboard/assets/img/home/document/book-open.svg') }}" alt="">
                                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="document-card">
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <img class="document-icon" src="{{ asset('asset-dashboard/assets/img/home/history/photo.png') }}" alt="">
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <img class="document-icon" src="{{ asset('asset-dashboard/assets/img/home/history/photo-1') }}.png" alt="">
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <img class="document-icon" src="{{ asset('asset-dashboard/assets/img/home/history/photo-2') }}.png" alt="">
                            ...
                            <div class="document-item">
                                <div class="d-flex justify-content-start align-items-center">
                                    <img class="document-icon" src="{{ asset('asset-dashboard/assets/img/home/history/photo-3') }}.png" alt="">
